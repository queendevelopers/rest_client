...
String luciConsoleLink(String channel, String groupName) {
  ...
  assert(
    <String>['framework', 'engine', 'devicelab', 'packaging']
        .contains(groupName),
...
String presentState(pb.ConductorState state) {
  ...
  buffer.writeln(
      '\tPost-submit LUCI dashboard: ${luciConsoleLink(state.releaseChannel, 'framework')}');
  buffer.writeln(
      '\tDevicelab LUCI dashboard: ${luciConsoleLink(state.releaseChannel, 'devicelab')}');
