...
Future<void> testWithOutput(
    String name, Future<void> Function() body, String expectedOutput) async {
  test(name, () async {
    ...
    await runZoned<Future<void>>(body,
        zoneSpecification: ZoneSpecification(print: _recordPrint));
...
void main() {
  ...
  group('FlutterGoldenFileComparator', () {
    ...
    group('Local', () {
      ...
      testWithOutput(
          'passes non-existent baseline for new test, null expectation',
          () async {
        expect(
          await comparator.compare(
      ...
      test('compare properly awaits validation & output before failing.',
          () async {
