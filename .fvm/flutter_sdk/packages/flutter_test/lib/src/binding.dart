...
abstract class TestWidgetsFlutterBinding extends BindingBase
  ...
  static WidgetsBinding ensureInitialized(
      ...
      binding.ensureInitialized(environment);
...
class AutomatedTestWidgetsFlutterBinding extends TestWidgetsFlutterBinding {
  ...
  @override
  void addTime(Duration duration) {
    if (_timeout != null) _timeout = _timeout! + duration;
  }
...
class LiveTestWidgetsFlutterBinding extends TestWidgetsFlutterBinding {
  ...
  Future<T?> runAsync<T>(
    ...
    addTime(
        additionalTime); // doesn't do anything since we don't actually track the timeout, but just for correctness...
