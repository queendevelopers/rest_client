...
void main() {
  ...
  test(
      'RenderEditable registers and unregisters raw keyboard listener correctly',
      () async {
    final TextSelectionDelegate delegate = FakeEditableTextState()
      ..textEditingValue = const TextEditingValue(
        text: 'how are you',
  ...
  testVariants('respects enableInteractiveSelection', () async {
    ...
    await simulateKeyUpEvent(LogicalKeyboardKey.shift);
      ...
      variant: KeySimulatorTransitModeVariant
          .all()); // https://github.com/flutter/flutter/issues/58068
  ...
  group('delete API implementations', () {
    ...
    test('delete is not racy and handles composing region correctly', () {
      ...
      final TextEditingValue textEditingValue =
          editable.textSelectionDelegate.textEditingValue;
