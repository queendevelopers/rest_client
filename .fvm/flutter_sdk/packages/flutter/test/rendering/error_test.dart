...
void main() {
  ...
  testWidgets('test draw error paragraph', (WidgetTester tester) async {
    ...
    await tester
        .pumpWidget(Center(child: SizedBox(width: 100.0, child: _error)));
    ...
    await tester
        .pumpWidget(Center(child: SizedBox(height: 100.0, child: _error)));
    expect(tester.takeException(), null);

    await tester.pumpWidget(Center(
        child: SizedBox(key: UniqueKey(), height: 100.0, child: _error)));
    expect(tester.takeException(), 'pillow');
    expect(
      find.byType(ErrorWidget),
      paints
