...
void main() {
  ...
  testWidgets('Large title nav bar scrolls', (WidgetTester tester) async {
    ...
    expect(
        tester.getTopLeft(find.widgetWithText(OverflowBox, 'Title')).dy, 44.0);
    expect(
        tester.getSize(find.widgetWithText(OverflowBox, 'Title')).height, 52.0);
  ...
  testWidgets('Small title can be overridden', (WidgetTester tester) async {
    ...
    expect(tester.getBottomLeft(find.text('Title')).dy,
        44.0 - 8.0); // Extension gone, (static part - padding) left.
  });
