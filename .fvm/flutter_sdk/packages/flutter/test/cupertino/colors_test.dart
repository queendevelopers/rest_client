...
void main() {
  ...
  testWidgets('Dynamic color with all 3 dependencies works',
    ...
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(
            platformBrightness: Brightness.light, highContrast: false),
    ...
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(
            platformBrightness: Brightness.dark, highContrast: false),
        child: CupertinoUserInterfaceLevel(
          data: CupertinoUserInterfaceLevelData.base,
          child: DependentWidget(color: dynamicRainbowColor1),
        ),
    ...
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(
            platformBrightness: Brightness.light, highContrast: true),
        child: CupertinoUserInterfaceLevel(
          data: CupertinoUserInterfaceLevelData.base,
          child: DependentWidget(color: dynamicRainbowColor1),
        ),
