...
void main() {
  testWidgets('AutofillGroup has the right clients',
    ...
    final EditableTextState clientState1 = tester.state<EditableTextState>(
      find.descendant(
          of: find.byWidget(client1), matching: find.byType(EditableText)),
    );
    final EditableTextState clientState2 = tester.state<EditableTextState>(
      find.descendant(
          of: find.byWidget(client2), matching: find.byType(EditableText)),
    );
  ...
  testWidgets('AutofillGroup has the right clients after reparenting',
    ...
    final EditableTextState clientState3 = tester.state<EditableTextState>(
      find.descendant(
          of: find.byKey(keyClient3), matching: find.byType(EditableText)),
    );
