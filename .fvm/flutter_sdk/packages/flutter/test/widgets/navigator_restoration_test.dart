...
class PagedTestWidget extends StatelessWidget {
  const PagedTestWidget({Key? key, this.restorationId = 'app'})
      : super(key: key);
...
class TestPage extends Page<void> {
  const TestPage({LocalKey? key, required String name, String? restorationId})
      : super(name: name, key: key, restorationId: restorationId);
...
class RouteWidget extends StatefulWidget {
  const RouteWidget({Key? key, required this.name, this.arguments})
      : super(key: key);
...
class _RouteFinder extends MatchFinder {
  _RouteFinder(this.name,
      {this.arguments, this.count, bool skipOffstage = true})
