...
void main() {
  group('AndroidView', () {
    ...
    testWidgets(
      ...
      expect(
          lastPlatformViewTextClient.containsKey('usesVirtualDisplay'), true);
  ...
  group('Common PlatformView', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(() => tester.allWidgets.whereType<SizedBox>().first,
            returnsNormally);
        ...
        expect(() => tester.allWidgets.whereType<PlatformViewSurface>().first,
            returnsNormally);
    ...
    testWidgets(
      ...
      expect(
          lastPlatformViewTextClient.containsKey('usesVirtualDisplay'), false);
    });
  });
