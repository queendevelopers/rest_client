...
void main() {
  ...
  testWidgets('Scrollbar passes controller to CupertinoScrollbar',
      (WidgetTester tester) async {
    final ScrollController controller = ScrollController();
    Widget viewWithScroll(TargetPlatform? platform) {
      return _buildBoilerplate(
  ...
  testWidgets('Scrollbar dragging can be disabled',
      (WidgetTester tester) async {
    final ScrollController scrollController = ScrollController();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Scrollbar scrollOrientation works correctly',
    ...
    await tester
        .pumpWidget(_buildScrollWithOrientation(ScrollbarOrientation.left));
    await tester.pumpAndSettle();
