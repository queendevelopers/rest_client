...
void main() {
  ...
  testWidgets('CheckboxThemeData implements debugFillProperties',
    ...
    expect(description[1],
        'fillColor: MaterialStateProperty.all(Color(0xfffffff0))');
    expect(description[2],
        'checkColor: MaterialStateProperty.all(Color(0xfffffff1))');
    ...
    expect(description[5],
        'materialTapTargetSize: MaterialTapTargetSize.shrinkWrap');
    expect(
        description[6], 'visualDensity: VisualDensity#00000(h: 0.0, v: 0.0)');
  });
  ...
  testWidgets('Checkbox is themeable', (WidgetTester tester) async {
    ...
    expect(
        _getCheckboxMaterial(tester), paints..drrect(color: defaultFillColor));
  ...
  testWidgets('Checkbox activeColor property is taken over the theme',
    ...
    await tester.pumpAndSettle();
    expect(_getCheckboxMaterial(tester),
        paints..drrect(color: themeDefaultFillColor));
