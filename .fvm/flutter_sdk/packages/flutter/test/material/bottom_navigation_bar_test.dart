...
void main() {
  ...
  testWidgets('BottomNavigationBar default layout',
    ...
    expect(tester.getRect(find.byKey(title0)),
        const Rect.fromLTRB(100, 572, 300, 582));
    expect(tester.getRect(find.byKey(icon0)),
        const Rect.fromLTRB(100, 562, 300, 572));
    expect(tester.getRect(find.byKey(icon1)),
        const Rect.fromLTRB(500, 562, 700, 572));
  });
  ...
  testWidgets('BottomNavigationBar centered landscape layout',
    ...
    expect(tester.getRect(find.byKey(title0)),
        const Rect.fromLTRB(150.0, 572.0, 350.0, 582.0));
    expect(tester.getRect(find.byKey(icon0)),
        const Rect.fromLTRB(150, 562, 350, 572));
    expect(tester.getRect(find.byKey(icon1)),
        const Rect.fromLTRB(450, 562, 650, 572));
  });
  ...
  testWidgets('BottomNavigationBar linear landscape layout',
    ...
    expect(tester.getRect(find.byKey(title0)),
        const Rect.fromLTRB(204, 562, 304, 582));
    expect(tester.getRect(find.byKey(icon0)),
        const Rect.fromLTRB(96, 562, 196, 582));
    expect(tester.getRect(find.byKey(icon1)),
        const Rect.fromLTRB(496, 562, 596, 582));
  });
}
