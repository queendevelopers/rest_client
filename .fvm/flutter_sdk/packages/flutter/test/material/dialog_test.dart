...
const ShapeBorder _defaultDialogShape = RoundedRectangleBorder(
...
void main() {
  ...
  group('Dialog children padding is correct', () {
    ...
    Future<void> openDialog(
        WidgetTester tester, Widget dialog, double textScaleFactor) async {
      await tester.pumpWidget(
  ...
  testWidgets('AlertDialog widget contains route semantics from title for iOS',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Dismissible.confirmDismiss defers to an AlertDialog',
    ...
    Future<bool?> confirmDismiss(DismissDirection dismissDirection) async {
      return showDialog<bool>(
        ...
        barrierDismissible:
            true, // showDialog() returns null if tapped outside the dialog
        builder: (BuildContext context) {
          return AlertDialog(
            actions: <Widget>[
              TextButton(
