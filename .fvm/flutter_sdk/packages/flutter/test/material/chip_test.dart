...
void main() {
  ...
  testWidgets('Chip defers to theme, if shape and side resolves to null',
    ...
    const BorderSide themeBorderSide =
        BorderSide(color: Color(0x00000001), width: 1);
    const BorderSide selectedBorderSide =
        BorderSide(color: Color(0x00000002), width: 1);
  ...
  testWidgets('Chip delete button tooltip can be disabled',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      _chipWithOptionalDeleteButton(
        deletable: true,
