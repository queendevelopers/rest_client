...
void main() {
  ...
  testWidgets('Does OutlineButton work with hover',
  ...
  testWidgets('OutlineButton changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('Does OutlineButton work with focus',
      (WidgetTester tester) async {
  ...
  testWidgets('Does OutlineButton work with autofocus',
      (WidgetTester tester) async {
    const Color focusColor = Color(0xff001122);
  ...
  testWidgets(
    ...
    Color? textColor() {
      return tester
          .renderObject<RenderParagraph>(find.text('OutlineButton'))
          .text
          .style!
          .color;
    }
  ...
  testWidgets(
      'OutlineButton uses stateful color for icon color in different states',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
  ...
  testWidgets(
      'OutlineButton uses stateful color for border color in different states',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
          ...
          body: Center(
            child: OutlineButton(
              ...
              borderSide: BorderSide(
                  color: MaterialStateColor.resolveWith(getBorderColor)),
              child: const Text('OutlineButton'),
            ),
          ),
        ),
  ...
  testWidgets(
      'OutlineButton ignores highlightBorderColor if border color is stateful',
      (WidgetTester tester) async {
    const Color pressedColor = Color(0x00000001);
    const Color defaultColor = Color(0x00000002);
  ...
  testWidgets(
      'OutlineButton ignores disabledBorderColor if border color is stateful',
      (WidgetTester tester) async {
    const Color disabledColor = Color(0x00000001);
    const Color defaultColor = Color(0x00000002);
  ...
  testWidgets('OutlineButton respects the provided materialTapTargetSize',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
    ...
    expect(tester.getSize(find.byKey(key1)),
        Size(86 + addAlarmIconSize.width, 48.0));
    ...
    expect(
        tester.getSize(find.byKey(key2)), Size(86 + addIconSize.width, 36.0));
  });
  ...
  testWidgets('OutlineButton responds to density changes.',
      (WidgetTester tester) async {
