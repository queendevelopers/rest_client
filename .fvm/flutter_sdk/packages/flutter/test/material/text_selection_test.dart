...
void main() {
  ...
  group('material handles', () {
    ...
    testWidgets('works with 3 positional parameters',
        (WidgetTester tester) async {
  ...
  testWidgets('Paste only appears when clipboard has contents',
      (WidgetTester tester) async {
  ...
  testWidgets('Paste always appears regardless of clipboard content on iOS',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
