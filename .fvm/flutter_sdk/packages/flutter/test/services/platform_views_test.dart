  ...
  group('Android', () {
    ...
    test('create Android views', () async {
      ...
      await PlatformViewsService.initSurfaceAndroidView(
              id: 2, viewType: 'webview', layoutDirection: TextDirection.rtl)
          .create();
      expect(
        ...
        unorderedEquals(<FakeAndroidPlatformView>[
          ...
          const FakeAndroidPlatformView(2, 'webview', null,
              AndroidViewController.kAndroidLayoutDirectionRtl, true),
        ]),
      );
    });
    ...
    test('dispose clears focusCallbacks', () async {
      ...
      await SystemChannels.platform_views.binaryMessenger.handlePlatformMessage(
