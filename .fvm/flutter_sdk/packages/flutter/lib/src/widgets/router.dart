...
class _RouterState<T> extends State<Router<T>> with RestorationMixin {
  ...
  _IntentionToReportRouteInformation _currentIntentionToReport =
      _IntentionToReportRouteInformation.none;
  ...
  void _reportRouteInformation(Duration timestamp) {
    ...
    if (_routeInformation.value != null) {
      final RouteInformation oldRouteInformation =
      ...
      switch (_currentIntentionToReport) {
        ...
        case _IntentionToReportRouteInformation.ignore:
          if (oldRouteInformation.location !=
                  currentRouteInformation.location ||
        ...
        case _IntentionToReportRouteInformation.maybe:
          if (oldRouteInformation.location !=
              currentRouteInformation.location) {
            widget.routeInformationProvider!
                .routerReportsNewRouteInformation(currentRouteInformation);
          } else if (oldRouteInformation.state !=
              currentRouteInformation.state) {
            widget.routeInformationProvider!.routerReportsNewRouteInformation(
                currentRouteInformation,
                isNavigation: false);
          }
