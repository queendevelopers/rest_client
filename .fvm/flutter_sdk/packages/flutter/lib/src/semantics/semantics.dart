...
class AttributedString {
  ...
  AttributedString operator +(AttributedString other) {
    ...
    final List<StringAttribute> newAttributes =
        List<StringAttribute>.from(attributes);
...
class SemanticsData with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('label',
        attributedLabel.attributes.isEmpty ? label : attributedLabel.toString(),
        defaultValue: ''));
    properties.add(StringProperty('value',
        attributedValue.attributes.isEmpty ? value : attributedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'increasedValue',
        attributedIncreasedValue.attributes.isEmpty
            ? increasedValue
            : attributedIncreasedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'decreasedValue',
        attributedDecreasedValue.attributes.isEmpty
            ? decreasedValue
            : attributedDecreasedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty('hint',
        attributedHint.attributes.isEmpty ? hint : attributedHint.toString(),
        defaultValue: ''));
...
class SemanticsProperties extends DiagnosticableTree {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('attributedLabel', attributedLabel.toString(),
        defaultValue: ''));
    properties.add(StringProperty('value', value));
    properties.add(StringProperty('attributedValue', attributedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty('hint', hint));
    properties.add(StringProperty('attributedHint', attributedHint.toString(),
        defaultValue: ''));
    properties.add(EnumProperty<TextDirection>('textDirection', textDirection,
        defaultValue: null));
...
class SemanticsNode extends AbstractNode with DiagnosticableTreeMixin {
  ...
  void updateWith({
    ...
    _actions =
        Map<SemanticsAction, SemanticsActionHandler>.from(config._actions);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty(
        'label',
        _attributedLabel.attributes.isEmpty
            ? _attributedLabel.string
            : _attributedLabel.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'value',
        _attributedValue.attributes.isEmpty
            ? _attributedValue.string
            : _attributedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'increasedValue',
        _attributedIncreasedValue.attributes.isEmpty
            ? _attributedIncreasedValue.string
            : _attributedIncreasedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'decreasedValue',
        _attributedDecreasedValue.attributes.isEmpty
            ? _attributedDecreasedValue.string
            : _attributedDecreasedValue.toString(),
        defaultValue: ''));
    properties.add(StringProperty(
        'hint',
        _attributedHint.attributes.isEmpty
            ? _attributedHint.string
            : _attributedHint.toString(),
        defaultValue: ''));
