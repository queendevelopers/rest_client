...
void main() {
  ...
  group('network errors', () {
    testUsingContext('retries and deletes zip if gradle fails to unzip',
        () async {
...
''';
      ...
      expect(
          await networkErrorHandler.handler(), equals(GradleBuildStatus.retry));
...
''';
  ...
  group('license not accepted', () {
    ...
    testUsingContext('handler', () async {
      ...
      expect(
          testLogger.statusText,
          contains('Unable to download needed Android SDK components, as the '
...
assembleFooTest
      ...
      expect(
          testLogger.statusText,
          contains('The android/app/build.gradle file defines product '
