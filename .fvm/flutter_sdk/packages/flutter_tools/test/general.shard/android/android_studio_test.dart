  ...
  group('pluginsPath on Mac', () {
    ...
    testUsingContext(
      ...
      const Map<String, dynamic> jetbrainsInfoPlist = <String, dynamic>{
        ...
        'CFBundleVersion': '3.3',
        'JetBrainsToolboxApp':
            '$homeMac/Library/Application Support/JetBrains/Toolbox/apps/AndroidStudio/ch-0/183.5256920/Android Studio 3.3.app',
      };
...
class FakePlistUtils extends Fake implements PlistParser {
  final Map<String, Map<String, dynamic>> fileContents =
