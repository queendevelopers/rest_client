...
void main() {
  group('plugins', () {
    ...
    setUp(() async {
      ...
      systemClock = FakeSystemClock()..currentTime = DateTime(1970, 1, 1);
      ...
      for (final String nameOrPath in pluginNamesOrPaths) {
        ...
        pluginDirectory.childFile('pubspec.yaml')
          ...
          ..writeAsStringSync(pluginYamlTemplate.replaceAll(
              'PLUGIN_CLASS', toTitleCase(camelCase(name))));
...
''');
    ...
    group('refreshPlugins', () {
      ...
      testUsingContext(
        ...
        final Directory pluginA = createPluginWithDependencies(
            name: 'plugin-a',
        ...
        final Directory pluginB = createPluginWithDependencies(
            name: 'plugin-b', dependencies: const <String>['plugin-c']);
        final Directory pluginC = createPluginWithDependencies(
