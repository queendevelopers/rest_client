        ...
        const String singleDateMessageArbFileString = '''
{
  ...
  "@courseCompletion": {
    ...
    group('plural messages', () {
      testWithoutContext(
          'should throw attempting to generate a plural message without placeholders',
          () {
        ...
        const String pluralMessageWithIncorrectPlaceholderFormat = '''
{
  ...
  "@helloWorlds": {
    ...
    group('select messages', () {
      testWithoutContext(
          'should throw attempting to generate a select message without placeholders',
          () {
        const String selectMessageWithoutPlaceholdersAttribute = '''
{
  ...
  "@genderSelect": {
    "description": "Improperly formatted since it has no placeholder attribute."
      ...
      testWithoutContext(
          'should throw attempting to generate a select message with an empty placeholders map',
          () {
        const String selectMessageWithEmptyPlaceholdersMap = '''
{
  ...
  "@genderSelect": {
    ...
    "placeholders": {}
      ...
      testWithoutContext(
          'should throw attempting to generate a select message with no resource attributes',
          () {
