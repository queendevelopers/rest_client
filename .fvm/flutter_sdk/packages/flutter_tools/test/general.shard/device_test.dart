...
void main() {
  ...
  group('Filter devices', () {
    ...
    testWithoutContext(
        'Does not remove an unsupported device if FlutterProject is null',
        () async {
      final List<Device> devices = <Device>[
        unsupported,
      ];
  ...
  testWithoutContext(
    ...
    expect(
        computeDartVmFlags(
            DebuggingOptions.enabled(BuildInfo.debug, dartFlags: null)),
        '');
    expect(
        computeDartVmFlags(
...
class TestDeviceManager extends DeviceManager {
  TestDeviceManager(
    ...
    _deviceDiscoverers = <DeviceDiscovery>[
      ...
      if (deviceDiscoveryOverrides != null) ...deviceDiscoveryOverrides
    ];
