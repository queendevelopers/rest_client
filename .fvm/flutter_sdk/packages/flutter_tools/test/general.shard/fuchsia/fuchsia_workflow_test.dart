...
void main() {
  ...
  testWithoutContext(
    ...
    final FuchsiaWorkflow fuchsiaWorkflow = FuchsiaWorkflow(
      ...
      fuchsiaArtifacts: FuchsiaArtifacts(
          devFinder: devFinder, sshConfig: sshConfig, ffx: null),
      platform: FakePlatform(
          operatingSystem: 'linux', environment: <String, String>{}),
    );
  ...
  testWithoutContext(
      'Fuchsia workflow can not list and launch devices if there is no dev finder when ffx is disabled',
      () {
    final FuchsiaWorkflow fuchsiaWorkflow = FuchsiaWorkflow(
      featureFlags: TestFeatureFlags(),
      fuchsiaArtifacts:
          FuchsiaArtifacts(devFinder: null, sshConfig: sshConfig, ffx: ffx),
      platform: FakePlatform(
  ...
  testWithoutContext(
      'Fuchsia workflow can not launch devices if there is no ssh config when ffx is disabled',
      () {
    final FuchsiaWorkflow fuchsiaWorkflow = FuchsiaWorkflow(
      featureFlags: TestFeatureFlags(),
  ...
  testWithoutContext(
      'Fuchsia workflow can list and launch devices supported with sufficient SDK artifacts when ffx is disabled',
      () {
    final FuchsiaWorkflow fuchsiaWorkflow = FuchsiaWorkflow(
      featureFlags: TestFeatureFlags(),
      fuchsiaArtifacts: FuchsiaArtifacts(
