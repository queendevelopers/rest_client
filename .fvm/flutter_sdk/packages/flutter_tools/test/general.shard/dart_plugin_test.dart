...
void main() {
  group('Dart plugin registrant', () {
    ...
    group('resolvePlatformImplementation', () {
      ...
      testUsingContext(
          'provides error when plugin pubspec.yaml doesn\'t have "implementation" nor "default_implementation"',
          () async {
        final Set<String> directDependencies = <String>{
          'url_launcher_linux_1',
        };
      ...
      testUsingContext(
          'provides all errors when plugin pubspec.yaml doesn\'t have "implementation" nor "default_implementation"',
          () async {
        final Set<String> directDependencies = <String>{
          'url_launcher_linux',
...
''');
        final File generatedMainFile =
            flutterProject.directory.childFile('generated_main.dart');
