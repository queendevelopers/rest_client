...
''';
    ...
    expect(
      flutterManifest,
      matchesManifest(
          appVersion: '1.0.0+2', buildName: '1.0.0', buildNumber: '2'),
    );
  });
...
''';
    ...
    expect(
      flutterManifest,
      matchesManifest(
          appVersion: '0.0.1', buildName: '0.0.1', buildNumber: null),
    );
  });
...
''';
    ...
    expect(
      flutterManifest,
      matchesManifest(appVersion: '1.0+2', buildName: '1.0', buildNumber: '2'),
    );
  });
...
''';
    ...
    expect(
      flutterManifest,
      matchesManifest(appVersion: null, buildName: null, buildNumber: null),
    );
  });
