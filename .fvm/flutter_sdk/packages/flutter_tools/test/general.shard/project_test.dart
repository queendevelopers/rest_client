    ...
    group('ensure ready for platform-specific tooling', () {
      ...
      _testInMemory('Android project not on v2 embedding shows a warning',
        ...
        expect(testLogger.statusText,
            contains('https://flutter.dev/go/android-project-migration'));
      });
      _testInMemory(
      ...
      testUsingContext('injects plugins for macOS', () async {
        ...
        await project.regeneratePlatformSpecificTooling();
        expectExists(project.macos.managedDirectory
...
''';
    ...
    group('product bundle identifier', () {
      ...
      testWithMocks('handles case insensitive flavor', () async {
        ...
        mockXcodeProjectInterpreter.xcodeProjectInfo =
            XcodeProjectInfo(<String>[], <String>[], <String>['Free'], logger);
  ...
  group('watch companion', () {
    ...
    testUsingContext('cannot find bundle identifier', () async {
      ...
      expect(
          await project.ios
              .containsWatchCompanion(<String>['WatchTarget'], null),
          isFalse);
    }, overrides: <Type, Generator>{
      FileSystem: () => fs,
      ProcessManager: () => FakeProcessManager.any(),
...
void addIosProjectFile(Directory directory,
    {String Function() projectFileContent}) {
  directory
      .childDirectory('ios')
...
void addAndroidGradleFile(Directory directory,
    {String Function() gradleFileContent}) {
  directory
...
class MockXcodeProjectInterpreter extends Fake
