...
const List<VmServiceExpectation> kAttachIsolateExpectations =
    <VmServiceExpectation>[
  FakeVmServiceRequest(
      method: 'streamListen', args: <String, Object>{'streamId': 'Isolate'}),
...
void main() {
  ...
  testUsingContext('Can hot reload after attaching', () async {
    ...
    final OperationResult result =
        await residentWebRunner.restart(fullRestart: false);
  ...
  testUsingContext('Can hot restart after attaching', () async {
    ...
    expect(
        entrypointContents, contains('await ui.webOnlyInitializePlatform();'));
