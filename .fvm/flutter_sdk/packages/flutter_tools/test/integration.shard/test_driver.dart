...
abstract class FlutterTestDriver {
  ...
  Future<InstanceRef> evaluate(String targetId, String expression) async {
    return _timeoutWithMessages<InstanceRef>(
      () async => await _vmService.evaluate(
          await _getFlutterIsolateId(), targetId, expression) as InstanceRef,
  ...
  Future<SourcePosition> getSourceLocation() async {
    ...
    final Script script = await _vmService.getObject(
        flutterIsolateId, frame.location.script.id) as Script;
  ...
  Future<void> _setupProcess(
    ...
    unawaited(() async {
      try {
        ...
        _processPid =
            (connected['params'] as Map<String, dynamic>)['pid'] as int;
        ...
        if (withDebugger) {
          ...
          final String wsUriString =
              (debugPort['params'] as Map<String, dynamic>)['wsUri'] as String;
        ...
        _currentRunningAppId = ((await started)['params']
            as Map<String, dynamic>)['appId'] as String;
...
class FlutterTestTestDriver extends FlutterTestDriver {
  ...
  Future<void> _setupProcess(
    ...
    if (withDebugger) {
      final Map<String, dynamic> startedProcessParams = (await _waitFor(
          event: 'test.startedProcess',
          timeout: appStartTimeout))['params'] as Map<String, dynamic>;
  ...
  Future<Map<String, dynamic>> _waitForJson({
    ...
    return _timeoutWithMessages<Map<String, dynamic>>(
      () => _stdout.stream
          .map<Map<String, dynamic>>(_parseJsonResponse)
  ...
  if (line.startsWith('[') && line.endsWith(']') && line.length > 2) {
    try {
      final Map<String, dynamic> response =
          castStringKeyedMap((json.decode(line) as List<dynamic>)[0]);
      return response;
    } on FormatException {
