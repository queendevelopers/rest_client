...
void main() {
  ...
  testUsingContext('has correct content and formatting with app template',
      () async {
    Cache.flutterRoot = '../..';
  ...
  testUsingContext(
    ...
    () async {
      ...
      expect(loggingProcessManager.commands.first,
          contains(matches(r'dart-sdk[\\/]bin[\\/]pub')));
  ...
  testUsingContext('newly created plugin has min flutter sdk version as 1.20.0',
      () async {
    Cache.flutterRoot = '../..';
