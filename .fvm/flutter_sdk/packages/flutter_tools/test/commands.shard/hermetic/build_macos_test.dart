...
final Platform notMacosPlatform =
    FakePlatform(operatingSystem: 'linux', environment: <String, String>{
  'FLUTTER_ROOT': '/',
});
...
void main() {
  ...
  testUsingContext('macOS build forwards error stdout to status logger error',
    ...
    ProcessManager: () => FakeProcessManager.list(
        <FakeCommand>[setUpFakeXcodeBuildHandler('Debug')]),
    Platform: () => macosPlatform,
    FeatureFlags: () => TestFeatureFlags(isMacOSEnabled: true),
  });
  ...
  testUsingContext('macOS build invokes xcode build (debug) with verbosity',
    ...
    FileSystem: () => fileSystem,
    ProcessManager: () => FakeProcessManager.list(
        <FakeCommand>[setUpFakeXcodeBuildHandler('Debug', verbose: true)]),
    Platform: () => macosPlatform,
    FeatureFlags: () => TestFeatureFlags(isMacOSEnabled: true),
  });
  ...
  testUsingContext('macOS build invokes xcode build (profile)', () async {
    ...
    FileSystem: () => fileSystem,
    ProcessManager: () => FakeProcessManager.list(
        <FakeCommand>[setUpFakeXcodeBuildHandler('Profile')]),
    Platform: () => macosPlatform,
  ...
  testUsingContext('macOS build invokes xcode build (release)', () async {
    ...
    FileSystem: () => fileSystem,
    ProcessManager: () => FakeProcessManager.list(
        <FakeCommand>[setUpFakeXcodeBuildHandler('Release')]),
    Platform: () => macosPlatform,
    FeatureFlags: () => TestFeatureFlags(isMacOSEnabled: true),
  });
