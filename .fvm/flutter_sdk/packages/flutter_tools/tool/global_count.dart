...
final RegExp globalImport =
    RegExp(r"import.*(?:globals|globals_null_migrated)\.dart' as globals;");
final RegExp globalNullUnsafeImport =
    RegExp("import.*globals.dart' as globals;");
...
void countGlobalImports(Directory directory) {
  ...
  print(
      '${path.basename(directory.path)} contains $count libraries with global usage ($nullUnsafeImportCount unsafe)');
}
