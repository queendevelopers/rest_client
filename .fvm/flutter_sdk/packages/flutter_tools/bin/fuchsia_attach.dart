...
Future<void> main(List<String> args) async {
  ...
  final File frontendServer = globals.fs.file(
  ...
  final File platformKernelDill = globals.fs
      .file('$buildDirectory/flutter_runner_patched_sdk/platform_strong.dill');
  final File flutterPatchedSdk =
      globals.fs.file('$buildDirectory/flutter_runner_patched_sdk');
  ...
  final List<String> command = <String>[
    ...
    '--packages',
    packages,
    if (deviceName != null && deviceName.isNotEmpty) ...<String>[
      '-d',
      deviceName
    ],
    if (verbose) '--verbose',
