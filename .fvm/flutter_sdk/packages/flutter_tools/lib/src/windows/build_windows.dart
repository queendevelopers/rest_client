...
Future<void> buildWindows(
  ...
  final String buildModeName =
      getNameForBuildMode(buildInfo.mode ?? BuildMode.release);
  ...
  try {
    await _runCmakeGeneration(
        cmakePath, buildDirectory, windowsProject.cmakeFile.parent);
...
Future<void> _runCmakeGeneration(
    String cmakePath, Directory buildDir, Directory sourceDir) async {
