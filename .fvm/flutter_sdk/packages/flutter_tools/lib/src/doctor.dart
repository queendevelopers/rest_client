  ...
  Future<ValidationResult> validate() async {
    ...
    try {
      ...
      if (_platform.environment.containsKey('FLUTTER_GIT_URL')) {
        messages.add(ValidationMessage(_userMessages
            .flutterGitUrl(_platform.environment['FLUTTER_GIT_URL'])));
      }
      ...
      if (_platform.environment.containsKey('PUB_HOSTED_URL')) {
        messages.add(ValidationMessage(_userMessages
            .pubMirrorURL(_platform.environment['PUB_HOSTED_URL'])));
      }
      if (_platform.environment.containsKey('FLUTTER_STORAGE_BASE_URL')) {
        messages.add(ValidationMessage(_userMessages.flutterMirrorURL(
