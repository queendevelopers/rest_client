...
class IMobileDevice {
  ...
  bool get isInstalled =>
      _isInstalled ??= _processManager.canRun(_idevicescreenshotPath);
  bool _isInstalled;
  ...
  Future<void> takeScreenshot(
    ...
    return _processUtils.run(
      <String>[
        ...
        '--udid',
        deviceID,
        if (interfaceType == IOSDeviceInterface.network) '--network',
      ],
      throwOnError: true,
      environment: Map<String, String>.fromEntries(
          <MapEntry<String, String>>[_dyLdLibEntry]),
...
Future<XcodeBuildResult> buildXcodeProject({
  ...
  final Map<String, String> buildSettings = await app.project
          .buildSettingsForBuildInfo(buildInfo,
...
bool _checkXcodeVersion() {
  ...
  if (!globals.xcode.isRequiredVersionSatisfactory) {
    globals.printError(
        'Found "${globals.xcodeProjectInterpreter.versionText}". $_xcodeRequirement');
    return false;
  }
  return true;
}
