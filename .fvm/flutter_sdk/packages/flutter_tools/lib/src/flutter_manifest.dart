...
class FlutterManifest {
  ...
  List<Font> _extractFonts() {
    ...
    for (final Map<String, Object?> fontFamily in _rawFontsDescriptor) {
      ...
      if (familyName == null) {
        _logger.printError('Warning: Missing family name for font.',
            emphasis: true);
        continue;
      }
      if (fontFiles == null) {
        _logger.printError('Warning: No fonts specified for font $familyName',
            emphasis: true);
        continue;
      }
      ...
      for (final Map<Object?, Object?> fontFile
        ...
        if (asset == null) {
          _logger.printError('Warning: Missing asset in fonts for $familyName',
              emphasis: true);
          continue;
        }
