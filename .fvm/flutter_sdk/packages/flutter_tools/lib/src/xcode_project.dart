...
class IosProject extends FlutterProjectPlatform implements XcodeBasedProject {
  ...
  Future<Map<String, String>?> buildSettingsForBuildInfo(BuildInfo? buildInfo,
      {EnvironmentType environmentType = EnvironmentType.physical}) async {
    if (!existsSync()) {
      return null;
    }
  ...
  Future<bool> containsWatchCompanion(
    ...
    for (final String target in targets) {
      ...
      if (infoFile.existsSync()) {
        final String? fromPlist = globals.plistParser
            .getValueFromFile(infoFile.path, 'WKCompanionAppBundleIdentifier');
        ...
        if (fromPlist != null && fromPlist.contains(r'$')) {
          final Map<String, String>? allBuildSettings =
              await buildSettingsForBuildInfo(buildInfo);
          if (allBuildSettings != null) {
            final String substituedVariable =
