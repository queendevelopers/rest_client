...
class AndroidPlugin extends PluginPlatform {
  ...
  Set<String> get _supportedEmbeddings =>
      _cachedEmbeddingVersion ??= _getSupportedEmbeddings();
...
class IOSPlugin extends PluginPlatform {
  ...
  factory IOSPlugin.fromYaml(String name, YamlMap yaml) {
    assert(validate(
        yaml)); // TODO(jonahwilliams): https://github.com/flutter/flutter/issues/67241
    return IOSPlugin(
      name: name,
      classPrefix: '',
      pluginClass: yaml['pluginClass'] as String,
