  ...
  if (printStructuredErrorLogMethod != null) {
    ...
    registrationRequests.add(vmService
        ...
        .catchError((dynamic error) {},
            test: (dynamic error) => error is vm_service.RPCError));
  }
...
class FlutterVmService {
  ...
  Future<Map<String, dynamic>> _flutterToggle(
    String name, {
    @required String isolateId,
  }) async {
  ...
  Future<Map<String, dynamic>> flutterDebugAllowBanner(
    bool show, {
    @required String isolateId,
  }) {
  ...
  Future<Map<String, dynamic>> flutterEvictAsset(
    String assetPath, {
    @required String isolateId,
  }) {
    return invokeFlutterExtensionRpcRaw(
  ...
  Future<vm_service.Isolate> getIsolateOrNull(String isolateId) {
    return service.getIsolate(isolateId).catchError(
