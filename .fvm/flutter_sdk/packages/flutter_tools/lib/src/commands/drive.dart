...
import '../runner/flutter_command.dart'
    show FlutterCommandResult, FlutterOptions;
...
class DriveCommand extends RunCommandBase {
  DriveCommand({
    ...
    argParser
      ...
      ..addFlag(
        ...
        defaultsTo: true,
        help:
            '(deprecated) Build the app before running. To use an existing app, pass the "--use-application-binary" '
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    final Device device = await findTargetDevice(
        includeUnsupportedDevices: stringArg('use-application-binary') == null);
    if (device == null) {
      throwToolExit(null);
    }
